...
class rectangle
{
	...
	public static void Main()
	{
		...
		double x2 = shift_x(30.0, 0.0);
		double y2 = shift_y(30.0, 0.0);
		double x3 = shift_x(30.0, 30.0);
		double y3 = shift_y(30.0, 30.0);
		double x4 = shift_x(0.0, 30.0);
		double y4 = shift_y(0.0, 30.0);
